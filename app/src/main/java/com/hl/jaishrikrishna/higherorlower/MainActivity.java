package com.hl.jaishrikrishna.higherorlower;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void guessClicked(View view){
        EditText numEditText = (EditText) findViewById(R.id.guessedNumber);
        sUsername =numEditText.getText().toString();
        if (sUsername.matches("")) {
            Toast.makeText(this, "You did not enter a number", Toast.LENGTH_SHORT).show();
            return;
        }

        EditText guessNum = (EditText) findViewById(R.id.guessedNumber);
